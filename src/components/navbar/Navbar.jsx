  ...
  return (
    <nav className="flex justify-between items-center px-10 py-5 bg-white sticky top-0 z-50 shadow-sm container mx-auto">
      ...
      <div className="hidden md:flex gap-8 font-medium">
        <a href="#" className="hover:text-[#4F39F6] transition">Products</a>
        <a href="#" className="hover:text-[#4F39F6] transition">Features</a>
        <a href="#" className="hover:text-[#4F39F6] transition">Pricing</a>
        <a href="#" className="hover:text-[#4F39F6] transition">Testimonials</a>
        <a href="#" className="hover:text-[#4F39F6] transition">FAQ</a>
      </div>

      {/* Actions (Login, Cart, Button) */}
      <div className="flex items-center gap-6">
        ...
        <div className="relative cursor-pointer">
          ...
          {/* Badge: Shudhu jakhon cart-e item thakbe takhon-i dekhabe */}
          {cartCount > 0 && (
