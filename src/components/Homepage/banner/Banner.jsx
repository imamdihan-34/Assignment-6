...
const Banner = () => (
  ...
  <span class="text-lg font-medium text-purple-700">
    New: AI-Powered Tools Available
      ...
      <p className="my-4 text-[#627382] gap-1">Access premium AI tools, design assets, templates, and productivity <br></br>
software—all in one place. Start creating faster today.<br></br>

Explore Products
</p>
<div className='flex gap-2'>
      <button className="bg-gradient-to-b from-[#4F39F6] to-[#9514FA] text-white px-5 py-2 rounded-full text-xl">Explore Products</button>
