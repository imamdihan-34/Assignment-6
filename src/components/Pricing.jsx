    ...
    <section className="py-24 bg-gray-50 px-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto items-center">
        ...
        <div className="bg-white p-10 rounded-3xl shadow-sm border">
          ...
          <button className="w-full py-3 rounded-xl border border-violet-600 text-violet-600 font-bold hover:bg-violet-50 transition">
            Get Started Free
          </button>
        </div>
        ...
        <div className="bg-violet-600 p-10 rounded-3xl shadow-xl text-white transform md:scale-105 relative">
          <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-orange-400 text-white text-[10px] font-bold px-4 py-1 rounded-full uppercase tracking-wider">
            Most Popular
          </div>
          <h3 className="text-xl font-bold mb-2">Pro</h3>
          <p className="text-sm opacity-80 mb-6">For small teams.</p>
          <div className="text-4xl font-bold mb-8">
            $29<span className="text-lg font-normal opacity-60">/month</span>
          </div>
          ...
          <button className="w-full py-3 rounded-xl bg-white text-violet-600 font-bold hover:bg-gray-100 transition">
            Start Free Trial
          </button>
        </div>
        ...
        <div className="bg-white p-10 rounded-3xl shadow-sm border">
          ...
          <button className="w-full py-3 rounded-xl bg-violet-600 text-white font-bold hover:bg-violet-700 transition">
            Contact Sales
          </button>
        </div>
      </div>
